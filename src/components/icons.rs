...
#[component]
pub fn ChevronDownIcon(#[props(default)] size: IconSize, #[props(default)] class: String) -> Element {
    let size_class = size.class();
    let class = format!("{} {}", size_class, class);
...
#[component]
pub fn ChevronRightIcon(#[props(default)] size: IconSize, #[props(default)] class: String) -> Element {
    let size_class = size.class();
    let class = format!("{} {}", size_class, class);
...
#[component]
pub fn UserCircleIcon(#[props(default)] size: IconSize, #[props(default)] class: String) -> Element {
    let size_class = size.class();
    let class = format!("{} {}", size_class, class);
...
#[component]
pub fn ExclamationIcon(#[props(default)] size: IconSize, #[props(default)] class: String) -> Element {
    let size_class = size.class();
    let class = format!("{} {}", size_class, class);
...
#[component]
pub fn InformationIcon(#[props(default)] size: IconSize, #[props(default)] class: String) -> Element {
    let size_class = size.class();
    let class = format!("{} {}", size_class, class);
